    ...
    context "with a double" do
      ...
      describe "#with (no block)" do
        context "positional arguments" do
          it "modifies the accepted arguments" do
            ...
            double.can receive(:positional).with(1, 2).and_return(5)
          ...
          it "supports case equality" do
            double = ArgumentsDouble.new
            double.can receive(:positional).with(Int32, ->(x : Int32) { x.even? }).and_return(5)
            double.positional(1, 2).should eq(5)
        ...
        context "keyword arguments" do
          it "modifies the accepted arguments" do
            double = ArgumentsDouble.new
            double.can receive(:keywords).with(key1: 1, key2: 2).and_return(5)
          ...
          it "supports case equality" do
            double = ArgumentsDouble.new
            double.can receive(:keywords).with(key1: Int32, key2: ->(x : Int32) { x.even? }).and_return(5)
            double.keywords(key1: 1, key2: 2).should eq(5)
        ...
        context "splat arguments" do
          it "modifies the accepted arguments" do
            double = ArgumentsDouble.new
            double.can receive(:splat).with(1, 2).and_return(5)
          ...
          it "supports case equality" do
            double = ArgumentsDouble.new
            double.can receive(:splat).with(Int32, ->(x : Int32) { x.even? }).and_return(5)
            double.splat(1, 2).should eq(5)
        ...
        context "double splat arguments" do
          it "modifies the accepted arguments" do
            double = ArgumentsDouble.new
            double.can receive(:double_splat).with(key1: 1, key2: 2).and_return(5)
          ...
          it "supports case equality" do
            double = ArgumentsDouble.new
            double.can receive(:double_splat).with(key1: Int32, key2: ->(x : Int32) { x.even? }).and_return(5)
            double.double_splat(key1: 1, key2: 2).should eq(5)
        ...
        context "mixed arguments" do
          it "modifies the accepted arguments" do
            double = ArgumentsDouble.new
            double.can receive(:mixed).with(1, 2, 3, 4, key1: 5, key2: 6, key3: 7, key4: 8).and_return(5)
          ...
          it "supports case equality" do
            ...
            double.can receive(:mixed).with(Int32, is_even, String, /test/i, key1: Int, key2: is_even, key3: Object, key4: /test/i).and_return(5)
      ...
      describe "#with (block)" do
        context "positional arguments" do
          it "modifies the accepted arguments" do
            double = ArgumentsDouble.new
            double.can receive(:positional).with(1, 2) { 5 }
            double.positional(1, 2).should eq(5)
            double.positional(3, 4).should eq(0)
          end
          ...
          it "supports case equality" do
            double = ArgumentsDouble.new
            double.can receive(:positional).with(Int32, ->(x : Int32) { x.even? }) { 5 }
            double.positional(1, 2).should eq(5)
            double.positional("Test", 3).should eq(0)
          end
        end
        ...
        context "keyword arguments" do
          it "modifies the accepted arguments" do
            double = ArgumentsDouble.new
            double.can receive(:keywords).with(key1: 1, key2: 2) { 5 }
            double.keywords(key1: 1, key2: 2).should eq(5)
            double.keywords(key1: 3, key2: 4).should eq(0)
          end
          ...
          it "supports case equality" do
            double = ArgumentsDouble.new
            double.can receive(:keywords).with(key1: Int32, key2: ->(x : Int32) { x.even? }) { 5 }
            double.keywords(key1: 1, key2: 2).should eq(5)
            double.keywords(key1: "Test", key2: 3).should eq(0)
          end
        end
        ...
        context "splat arguments" do
          it "modifies the accepted arguments" do
            double = ArgumentsDouble.new
            double.can receive(:splat).with(1, 2) { 5 }
            double.splat(1, 2).should eq(5)
            double.splat(3, 4).should eq(0)
          end
          ...
          it "supports case equality" do
            double = ArgumentsDouble.new
            double.can receive(:splat).with(Int32, ->(x : Int32) { x.even? }) { 5 }
            double.splat(1, 2).should eq(5)
            double.splat("Test", 3).should eq(0)
          end
        end
        ...
        context "double splat arguments" do
          it "modifies the accepted arguments" do
            double = ArgumentsDouble.new
            double.can receive(:double_splat).with(key1: 1, key2: 2) { 5 }
            double.double_splat(key1: 1, key2: 2).should eq(5)
            double.double_splat(key1: 3, key2: 4).should eq(0)
          end
          ...
          it "supports case equality" do
            double = ArgumentsDouble.new
            double.can receive(:double_splat).with(key1: Int32, key2: ->(x : Int32) { x.even? }) { 5 }
            double.double_splat(key1: 1, key2: 2).should eq(5)
            double.double_splat(key1: "Test", key2: 3).should eq(0)
          end
        end
        ...
        context "mixed arguments" do
          it "modifies the accepted arguments" do
            double = ArgumentsDouble.new
            double.can receive(:mixed).with(1, 2, 3, 4, key1: 5, key2: 6, key3: 7, key4: 8) { 5 }
            double.mixed(1, 2, 3, 4, key1: 5, key2: 6, key3: 7, key4: 8).should eq(5)
            double.mixed(3, 4, 5, 6, key1: 7, key2: 8, key3: 9, key4: 0).should eq(0)
          end
          ...
          it "supports case equality" do
            double = ArgumentsDouble.new
            is_even = ->(x : Int32) { x.even? }
            double.can receive(:mixed).with(Int32, is_even, String, /test/i, key1: Int, key2: is_even, key3: Object, key4: /test/i) { 5 }
            double.mixed(1, 2, "Test", "Test", key1: 5, key2: 6, key3: "Test", key4: "Test").should eq(5)
            double.mixed("Test", "Test", 1, 2, key1: "Test", key2: "Test", key3: 3, key4: 4).should eq(0)
          end
        end
    ...
    context "with a mock" do
      ...
      describe "#with (no block)" do
        context "positional arguments" do
          it "modifies the accepted arguments" do
            ...
            mock.can receive(:positional).with(1, 2).and_return(5)
            mock.positional(1, 2).should eq(5)
            expect_raises(Mocks::UnexpectedMessage) do
              mock.positional(3, 4)
            end
          end
          ...
          it "supports case equality" do
            mock = ArgumentsClassMock.new
            mock.can receive(:positional).with(Int32, ->(x : Int32) { x.even? }).and_return(5)
            mock.positional(1, 2).should eq(5)
            expect_raises(Mocks::UnexpectedMessage) do
        ...
        context "keyword arguments" do
          it "modifies the accepted arguments" do
            mock = ArgumentsClassMock.new
            mock.can receive(:keywords).with(key1: 1, key2: 2).and_return(5)
          ...
          it "supports case equality" do
            mock = ArgumentsClassMock.new
            mock.can receive(:keywords).with(key1: Int32, key2: ->(x : Int32) { x.even? }).and_return(5)
            mock.keywords(key1: 1, key2: 2).should eq(5)
            expect_raises(Mocks::UnexpectedMessage) do
        ...
        context "splat arguments" do
          it "modifies the accepted arguments" do
            mock = ArgumentsClassMock.new
            mock.can receive(:splat).with(1, 2).and_return(5)
          ...
          it "supports case equality" do
            mock = ArgumentsClassMock.new
            mock.can receive(:splat).with(Int32, ->(x : Int32) { x.even? }).and_return(5)
            mock.splat(1, 2).should eq(5)
            expect_raises(Mocks::UnexpectedMessage) do
              mock.splat("Test", 3)
            end
        ...
        context "double splat arguments" do
          it "modifies the accepted arguments" do
            mock = ArgumentsClassMock.new
            mock.can receive(:double_splat).with(key1: 1, key2: 2).and_return(5)
          ...
          it "supports case equality" do
            mock = ArgumentsClassMock.new
            mock.can receive(:double_splat).with(key1: Int32, key2: ->(x : Int32) { x.even? }).and_return(5)
            mock.double_splat(key1: 1, key2: 2).should eq(5)
            expect_raises(Mocks::UnexpectedMessage) do
        ...
        context "mixed arguments" do
          it "modifies the accepted arguments" do
            mock = ArgumentsClassMock.new
            mock.can receive(:mixed).with(1, 2, 3, 4, key1: 5, key2: 6, key3: 7, key4: 8).and_return(5)
          ...
          it "supports case equality" do
            mock = ArgumentsClassMock.new
            is_even = ->(x : Int32) { x.even? }
            mock.can receive(:mixed).with(Int32, is_even, String, /test/i, key1: Int, key2: is_even, key3: Object, key4: /test/i).and_return(5)
      ...
      describe "#with (block)" do
        context "positional arguments" do
          it "modifies the accepted arguments" do
            mock = ArgumentsClassMock.new
            mock.can receive(:positional).with(1, 2) { 5 }
            mock.positional(1, 2).should eq(5)
            expect_raises(Mocks::UnexpectedMessage) do
              mock.positional(3, 4)
            end
          ...
          it "supports case equality" do
            mock = ArgumentsClassMock.new
            mock.can receive(:positional).with(Int32, ->(x : Int32) { x.even? }) { 5 }
            mock.positional(1, 2).should eq(5)
            expect_raises(Mocks::UnexpectedMessage) do
              mock.positional("Test", 3)
            end
        ...
        context "keyword arguments" do
          it "modifies the accepted arguments" do
            mock = ArgumentsClassMock.new
            mock.can receive(:keywords).with(key1: 1, key2: 2) { 5 }
            mock.keywords(key1: 1, key2: 2).should eq(5)
            expect_raises(Mocks::UnexpectedMessage) do
              mock.keywords(key1: 3, key2: 4)
            end
          ...
          it "supports case equality" do
            mock = ArgumentsClassMock.new
            mock.can receive(:keywords).with(key1: Int32, key2: ->(x : Int32) { x.even? }) { 5 }
            mock.keywords(key1: 1, key2: 2).should eq(5)
            expect_raises(Mocks::UnexpectedMessage) do
              mock.keywords(key1: "Test", key2: 3)
            end
        ...
        context "splat arguments" do
          it "modifies the accepted arguments" do
            mock = ArgumentsClassMock.new
            mock.can receive(:splat).with(1, 2) { 5 }
            mock.splat(1, 2).should eq(5)
            expect_raises(Mocks::UnexpectedMessage) do
              mock.splat(3, 4)
            end
          ...
          it "supports case equality" do
            mock = ArgumentsClassMock.new
            mock.can receive(:splat).with(Int32, ->(x : Int32) { x.even? }) { 5 }
            mock.splat(1, 2).should eq(5)
            expect_raises(Mocks::UnexpectedMessage) do
              mock.splat("Test", 3)
            end
        ...
        context "double splat arguments" do
          it "modifies the accepted arguments" do
            mock = ArgumentsClassMock.new
            mock.can receive(:double_splat).with(key1: 1, key2: 2) { 5 }
            mock.double_splat(key1: 1, key2: 2).should eq(5)
            expect_raises(Mocks::UnexpectedMessage) do
              mock.double_splat(key1: 3, key2: 4)
            end
          ...
          it "supports case equality" do
            mock = ArgumentsClassMock.new
            mock.can receive(:double_splat).with(key1: Int32, key2: ->(x : Int32) { x.even? }) { 5 }
            mock.double_splat(key1: 1, key2: 2).should eq(5)
            expect_raises(Mocks::UnexpectedMessage) do
              mock.double_splat(key1: "Test", key2: 3)
            end
        ...
        context "mixed arguments" do
          it "modifies the accepted arguments" do
            mock = ArgumentsClassMock.new
            mock.can receive(:mixed).with(1, 2, 3, 4, key1: 5, key2: 6, key3: 7, key4: 8) { 5 }
            mock.mixed(1, 2, 3, 4, key1: 5, key2: 6, key3: 7, key4: 8).should eq(5)
            expect_raises(Mocks::UnexpectedMessage) do
              mock.mixed(3, 4, 5, 6, key1: 7, key2: 8, key3: 9, key4: 0)
            end
          ...
          it "supports case equality" do
            mock = ArgumentsClassMock.new
            is_even = ->(x : Int32) { x.even? }
            mock.can receive(:mixed).with(Int32, is_even, String, /test/i, key1: Int, key2: is_even, key3: Object, key4: /test/i) { 5 }
            mock.mixed(1, 2, "Test", "Test", key1: 5, key2: 6, key3: "Test", key4: "Test").should eq(5)
            expect_raises(Mocks::UnexpectedMessage) do
              mock.mixed("Test", "Test", 1, 2, key1: "Test", key2: "Test", key3: 3, key4: 4)
            end
