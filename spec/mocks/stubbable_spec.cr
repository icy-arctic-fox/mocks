  ...
  describe "#stub" do
    ...
    context "with a method name" do
      it "raises when no stub is defined" do
        object = StubbableType.new
        expect_raises(::Mocks::UnexpectedMessage, /existing_method_syntax/) { object.existing_method_syntax(:existing) }
      end
